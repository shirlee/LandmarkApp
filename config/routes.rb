LandmarkApp::Application.routes.draw do
  
  root :to => 'landmarks#index'
  
  get "/landmarks" => 'landmarks#index', :as => :landmarks

  get "/landmarks/new" => 'landmarks#new', :as => :new_landmark
  
  get "landmarks/:id" => 'landmarks#show', :as => :landmark
  put "landmarks/:id" => 'landmarks#update', :as => :landmark
  delete "landmarks/:id" => 'landmarks#destroy', :as => :landmark
